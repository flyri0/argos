...
// The "Devices"/settings tab: the pairing flow ((a)/(b)) until this device
// is trusted, then device management ((c)/(d)). Trusted means it already
// has a token, or it's running on localhost, which §6.2 exempts from
// pairing entirely.
